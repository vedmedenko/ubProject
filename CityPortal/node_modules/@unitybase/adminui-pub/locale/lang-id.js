...
UB.i18nExtend({
  ...
  komanda: 'Command',
  tipKomandy: 'Type',
  naimenovanieKomandy: 'Name',
  naimenovanieFormy: 'Form',
  uslovieOtbora: 'Condition',
  atribut: 'Attribute',
  atributy: 'Attributes',
  svoystvo: 'Property',
  svoystva: 'Properties',
  ...
  ustanovit: 'Set',
  iskatV: 'Search in',
  iskatChto: 'Search what',
  iskatVNaydennom: 'Nested search',
  ishodiaschieRekvizity: 'Outgoing details',
  zapisey: 'record(s)',
  storedData: 'Stored data',
  ochistitKhranilischeSpravochnikov: "Clear dictionaries' store",
  resetGUIToDefault: 'Reset GUI settings',
  clearFormsCache: "Clear forms' store",
  dopolnitelno: 'Additionally',
  ...
  dobavitYarlik: 'Add shortcut',
  dobavitDirectoriu: 'Add folder',
  ...
  'fetchConfirm': 'Are you sure to load all data? \nOversized information can slow down the system',
