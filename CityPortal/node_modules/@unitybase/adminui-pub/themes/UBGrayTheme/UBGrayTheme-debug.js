...
Ext.define('ExtThemeUB.toolbar.Toolbar', {
    override: 'Ext.toolbar.Toolbar',
    minHeight: 29
});
...
Ext.define('ExtThemeUB.form.Labelable', {
    override: 'Ext.form.Labelable',
    labelWidth: 112,
});


Ext.define('ExtThemeUB.form.field.Base', {
    override: 'Ext.form.field.Base',
    labelWidth: 112,
});

Ext.define('ExtThemeUB.form.FieldSet', {
...
Ext.define('ExtThemeUB.form.Label', {
...
Ext.define('ExtThemeUB.form.field.Date', {
...
Ext.define('ExtThemeUB.grid.Panel', {
...
Ext.define('ExtThemeUB.resizer.Splitter', {
    override: 'Ext.resizer.Splitter',
    size: 4
});
...
Ext.define('UBtheme.menu.Separator', {
    override: 'Ext.menu.Separator',
    border: true
});
