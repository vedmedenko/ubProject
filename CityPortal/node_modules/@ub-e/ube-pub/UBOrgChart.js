/*global UB, js_beautify, mxConstants, mxGraph, mxUndoManager, mxLabel, mxEvent, mxRectangle, mxClient, mxImage, mxCellOverlay, mxPrintPreview, mxOutline, mxEdgeStyle, mxToolbar, mxDivResizer, mxPrintPreview, mxLayoutManager, mxCompactTreeLayout, mxKeyHandler, mxUtils, mxEditor, mxRubberband, mxCodec, mxBasePath, mxVertexHandler, mxCellRenderer, mxCell, mxGeometry, mxPoint, mxHierarchicalLayout, console, isDeveloperMode */
/**
 * Organization Chart Diagram
 */
Ext.define('UBE.UBOrgChart', {
    extend: 'Ext.Panel',
    ...
    initRoot: function(){
        ...
        try
        {
            ...
            v1 = graph.insertVertex(parent, 'treeRoot',
                node, w/2 - 30, 20, 140, 60, 'image=' + $App.getImagePath('office.png'));
        ...
        return  {xtype:  'toolbar',
            items: [
                ...
                },
                {
                    ...
                    xtype: 'button',
                    text: UB.i18n('Select'),
                    icon: window.mxBasePath + '/resources/images/select.gif',
                    handler:function(){
                    ...
                    xtype: 'button',
                    text: UB.i18n('Pan'),
                    icon: window.mxBasePath + '/resources/images/pan.gif',
                    handler:function(){
    ...
    createPopupMenu:  function (graph, menu, cell, evt){
        ...
        menu.addItem('Fit', $App.getImagePath('zoom_in.png'), function()
        {
            graph.fit();
        });

        menu.addItem('Actual', $App.getImagePath('view_1_1.png'), function()
        {
            graph.zoomActual();
        });
        ...
        menu.addItem('Print', $App.getImagePath('print.png'), function()
        {
            var preview = new mxPrintPreview(graph, 1);
            preview.open();
        });

        menu.addItem('Poster Print', $App.getImagePath('print.png'), function()
        {
            var pageCount = mxUtils.prompt('Enter maximum page count', '1');
   ...
   addElementEdge: function(cell, parentCell, item ){
    ...
    createNewDiagram: function(parentID, caption, callback){
        ...
        UB.core.UBService.runList([
            ...
            if (result && (_result = UB.core.UBUtil.getByPropertyValue(result, 'entity', 'org_diagram'))){
                    ...
                    {msg: UB.i18n('Chart for this item does not exist. Create a new one?'),
                        ...
                        callback: function(btn, value){
                            ...
                            me.createNewDiagram(ID,caption, function(nID){
                                diagramID = nID ;
                                this.openFormC({entityCode: 'org_diagram',
...
UB.ux.UBDocument.editors.ubOrgChart = 'UBE.UBOrgChart';
UB.ux.UBDocument.contentTypeMapping['application/uborgchart'] = 'UBE.UBOrgChart';
UB.ux.UBDocument.contentTypeMapping['application/UBOrgChart'] = 'UBE.UBOrgChart';
