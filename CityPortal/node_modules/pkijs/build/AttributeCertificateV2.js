   ...
   */
		value: function fromSchema(schema) {
			...
			if ("baseCertificateID" in asn1.result) {
				...
				this.baseCertificateID = new _AttributeCertificateV.IssuerSerial({ schema: asn1.result.baseCertificateID });
			}
...
var AttributeCertificateInfoV2 = exports.AttributeCertificateInfoV2 = function () {
	//**********************************************************************************
	/**
