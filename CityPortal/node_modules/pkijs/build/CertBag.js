...
var _AttributeCertificateV = require("./AttributeCertificateV2.js");
			...
			switch (this.certId) {
				case "1.2.840.113549.1.9.22.1":
					// x509Certificate
					{
						...
						{
							this.parsedValue = new _AttributeCertificateV2.default({ schema: asn1Inner.result });
						}
					}
					break;
				case "1.2.840.113549.1.9.22.3":
					// attributeCertificate - (!!!) THIS OID IS SUBJECT FOR CHANGE IN FUTURE (!!!)
					{
						...
						this.parsedValue = new _AttributeCertificateV2.default({ schema: _asn1Inner.result });
					}
					break;
